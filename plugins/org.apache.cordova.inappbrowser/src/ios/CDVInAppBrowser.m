...
- (void)createViews
{
    ...
    // SydJS Modification: Clipping to bounds so theres no gap between the status bar and toolbar
    ...
    // SydJS Modification: Changing toolbar to be solid black
    ...
    // SydJS Modification: Removing forward buton
    // NSString* frontArrowString = NSLocalizedString(@"►", nil); // create arrow from Unicode char
    // self.forwardButton = [[UIBarButtonItem alloc] initWithTitle:frontArrowString style:UIBarButtonItemStylePlain target:self action:@selector(goForward:)];
    // self.forwardButton.enabled = YES;
    // self.forwardButton.imageInsets = UIEdgeInsetsZero;
    
    // SydJS Modification: Removing back buton
    // NSString* backArrowString = NSLocalizedString(@"◄", nil); // create arrow from Unicode char
    // self.backButton = [[UIBarButtonItem alloc] initWithTitle:backArrowString style:UIBarButtonItemStylePlain target:self action:@selector(goBack:)];
    // self.backButton.enabled = YES;
    // self.backButton.imageInsets = UIEdgeInsetsZero;
    
    // SydJS Modification: Removing all buttons except close button
    // [self.toolbar setItems:@[self.closeButton, flexibleSpaceButton, self.backButton, fixedSpaceButton, self.forwardButton]];
    [self.toolbar setItems:@[flexibleSpaceButton, self.closeButton]];
    
    // SydJS Modification: Changing colour to black
...
- (void)setCloseButtonTitle:(NSString*)title
{
    ...
    self.closeButton.enabled = YES;
    // SydJS Modification: Changing colour of button to white
    ...
    // SydJS Modification: Increasing index to take into account the flexibleSpaceButon
    // [items replaceObjectAtIndex:0 withObject:self.closeButton];
    [items replaceObjectAtIndex:1 withObject:self.closeButton];
...
{
    // SydJS Modification: Changing status bar style to white
...
- (void)webViewDidStartLoad:(UIWebView*)theWebView
{
    ...
    self.addressLabel.text = NSLocalizedString(@"Loading...", nil);
    // SydJS Modification: Removing back and forward buttons
